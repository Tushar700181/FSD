...
router.get('/student-profile', authenticate, authorize(['student']), async (req, res) => {
    try {
...
router.post('/student-profile', authenticate, authorize(['student']), async (req, res) => {
    try {
        const userId = req.user._id;
...
router.post('/apply', authenticate, authorize(['student']), upload.single('resume'), async (req, res) => {
    try {
        const userId = req.user._id;
